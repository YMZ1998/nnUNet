...
class DicomImageView(QLabel):
    ...
    def __init__(self, parent=None):
        ...
        self.contour_line_width = 2.0  # ROI 轮廓线宽度
    ...
    def updateDisplay(self):
        ...
        if self.rois_to_draw:
            ...
            for roi_data in self.rois_to_draw:
                ...
                line_width = roi_data.get('line_width', 2.0)
...
class DicomViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.roi_line_width = {}  # {roi_name: float} - 每个 ROI 的线条粗细
    ...
    def loadRTStruct(self):
        ...
        try:
            ...
            for roi_name, roi_data in self.rois.items():
                ...
                self.roi_line_width[roi_name] = 2.0
    ...
    def onROISelectionChanged(self, current, previous):
        ...
        if current:
            ...
            self.line_width_spinbox.setValue(self.roi_line_width.get(roi_name, 2.0))
        else:
    ...
    def onROILineWidthChanged(self, value):
        ...
        if current_item:
            roi_name = current_item.text()
            self.roi_line_width[roi_name] = value
            # 更新图像视图的线条粗细
        ...
        for roi_name, roi_data in self.rois.items():
            ...
            if contours_2d:
                rois_to_draw.append({
                    ...
                    'line_width': self.roi_line_width.get(roi_name, 2.0)
                })
